...
public:
    ...
    /**
     *\brief Calculates the centre of mass of the board.
     *\return std::pair instance containing the centre of mass of the board.
     *
     * This function should only really be used with single objects such as gliders.
     * The centre of mass is calcuated according to r = \sum_{i}^{N} r_i/N, where r 
     * is a 2-D vector.
     */
    std::pair<double,double> centreOfMass() const;
    ...
    /**
     *\brief Checks whether there are any cell structures that have nearest neighbours
     * that cross a boundary.
     * \return Boolean value representing whether there are any cross boundary structures.
     */
     bool isCrossBoundaryStructure() const;

    /**
     *\brief Checks whether there are any live cells on the outer frame of the board.
     *\return Boolean value representing whether there are any live cells on the outer frame of the board.
     */
     bool isBoundaryLive() const;
